...
class RandomPizza extends Component{
    ...
    getRandom = () => {
        ...
        while(this.state.pizzas.data[rand].company.region !== this.state.location){
    ...
    render (){
        ...
        const { rPizzaName, buttonClicked, rPizzaTopping, rPizzaMidPrice, rPizzaSmallPrice, rPizzaBigPrice, rPizzaXlPrice, rPizzaCompany } = this.state
        var items = [{
            "name" : rPizzaName,
        ...
        <div>
            ...
            <a href="#" onClick={this.getRandom}>Finna pizzu!</a>
