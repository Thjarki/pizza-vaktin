...
const Card = ({name, companyName, topping, smallPrice, midPrice, bigPrice, xlPrice, animateDuration}) => {
    return (
        <div style={{animateDuration: `${animateDuration}s`}} className={styles.cardContainer}>
