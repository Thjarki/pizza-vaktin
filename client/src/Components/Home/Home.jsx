      ...
      for (var i = 0; i < this.state.pizzas.data.length; i++) {
        if (
          ...
          if (!this.props.specificTopping) {
            ...
            this.state.pizzas.data[i].toppings.length === this.state.toppings.length
          ) {
            items.push(pushItems);
          }
        }
...
>>>>>>> 5c70c04ea84eb32f421db9f7da5c66b36fa60516
      gat.push(
...
function mapStateToProps(state) {
  return {chosenToppings : state.toppings, location : state.location, specificTopping : state.specificTopping}
}
